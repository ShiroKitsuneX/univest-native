...
| **10. Polish & motion** | Empty states, loading skeletons, subtle micro-interactions on the active tab and primary buttons via React Native `Animated`. | 🟡 Pending |
| **11. Brand surfaces** | App icon (`assets/icon.png`), splash artwork, adaptive icon (Android), notification icon, App Store screenshots stub. | 🟡 Pending |
