          ...
          <>
            ...
            >
              ...
              <Text style={{ color: T.sub, fontSize: 13, lineHeight: 20 }}>
                Esta prova está prevista para {exam.date}. Quando estiver
                disponível, você poderá baixar o PDF e acessar pelo site da
                instituição.
              </Text>
            </View>
            <View
            ...
            >
              <Text style={{ color: T.text, fontSize: 13, marginBottom: 8 }}>
                ⏱️ Duração:{' '}
                <Text style={{ fontWeight: '700' }}>{exam.duration}</Text>
              </Text>
              <Text style={{ color: T.text, fontSize: 13 }}>
                ❓ Questões:{' '}
                <Text style={{ fontWeight: '700' }}>{exam.questions}</Text>
              </Text>
            </View>
            <TouchableOpacity
              onPress={() => Linking.openURL(exam.sourceUrl)}
              style={{
                flexDirection: 'row',
                alignItems: 'center',
            ...
            >
              ...
              <Text style={{ color: AT, fontSize: 14, fontWeight: '700' }}>
                Acompanhar no site
              </Text>
            </TouchableOpacity>
          </>
          ...
          <>
            ...
            >
              <View style={{ flexDirection: 'row', marginBottom: 10 }}>
                <Text style={{ color: T.sub, fontSize: 13, width: 80 }}>
                  📅 Data
                </Text>
                <Text
            ...
            <View style={{ flexDirection: 'row', gap: 10 }}>
              ...
              >
                ...
                <Text style={{ color: AT, fontSize: 13, fontWeight: '700' }}>
                  Site
                </Text>
              </TouchableOpacity>
              {exam.pdfUrl ? (
                <TouchableOpacity
                  onPress={() => Linking.openURL(exam.pdfUrl)}
                  style={{
                    flex: 1,
                    flexDirection: 'row',
                    alignItems: 'center',
