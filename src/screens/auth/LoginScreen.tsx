      ...
      >
        ...
        {!forgotMode && !passwordSent && (
          <>
            ...
            <Text style={{ color: T.sub, fontSize: 12, marginBottom: 6 }}>
              E-mail
            </Text>
            <TextInput
              value={authEmail}
              ...
              style={{
                ...
                borderWidth: 1,
                borderColor:
                  authTouched.email && !authEmail ? '#f87171' : T.border,
            ...
            <View style={{ marginBottom: 8 }}>
              <TextInput
                ...
                placeholder={
                  loginMode === 'signup' ? 'Mínimo 8 caracteres' : '••••••••'
                }
                placeholderTextColor={T.muted}
            ...
            {loginMode === 'signup' && (
              <View style={{ marginBottom: 12, marginTop: -4 }}>
                ...
                >
                  {[
                    ['8+', /.{8,}/] as [string, RegExp],
                    ['A-Z', /[A-Z]/] as [string, RegExp],
                    ['a-z', /[a-z]/] as [string, RegExp],
                    ['0-9', /\d/] as [string, RegExp],
                  ].map(([req, regex]) => {
              ...
              <>
                ...
                <View style={{ marginBottom: 8 }}>
                  <TextInput
                    ...
                    onChangeText={t => {
                      ...
                      setAuthTouched(p => ({ ...p, confirmarSenha: true }))
                    }}
                    placeholder="••••••••"
                    placeholderTextColor={T.muted}
                    secureTextEntry={!showLoginPwd}
                ...
                <TextInput
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    borderWidth: 1,
                    borderColor: authTouched.nascimento ? '#f87171' : T.border,
                    backgroundColor: T.inp,
                    color: T.text,
                    fontSize: 14,
                    marginBottom: 16,
                  ...
                  >
                    <View
                      style={{
                        ...
                        height: 22,
                        borderRadius: 6,
                        backgroundColor: authAcceptTerms ? T.accent : T.inp,
                        borderWidth: 1,
                        borderColor: authAcceptTerms ? T.accent : T.border,
                        alignItems: 'center',
                        justifyContent: 'center',
                      }}
                    >
                      {authAcceptTerms && (
                        <Text
                          style={{ color: AT, fontSize: 14, fontWeight: '700' }}
                        >
                          ✓
                        </Text>
                      )}
            ...
            <TouchableOpacity
              onPress={loginMode === 'login' ? handleLogin : handleSignup}
        ...
        {forgotMode && !passwordSent && (
          <>
            ...
            >
              <Text style={{ color: T.sub, fontSize: 13 }}>← Voltar</Text>
            </TouchableOpacity>
            <Text
              style={{
                color: T.text,
