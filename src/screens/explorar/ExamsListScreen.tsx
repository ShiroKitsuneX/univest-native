    ...
    <View style={{ flex: 1, backgroundColor: T.bg }}>
      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 16, paddingTop: 16 }}>
        <View style={{ flexDirection: 'row', gap: 8, marginBottom: 16 }}>
          <TouchableOpacity
            onPress={() => setExamSort('newest')}
            style={{
              flex: 1,
              padding: 10,
              borderRadius: 12,
              backgroundColor: examSort === 'newest' ? T.accent : T.card2,
              alignItems: 'center',
              borderWidth: 1,
              borderColor: examSort === 'newest' ? T.accent : T.border,
            }}
          >
            <Text
              style={{
                color: examSort === 'newest' ? AT : T.sub,
                fontSize: 12,
                fontWeight: '700',
              }}
            >
          ...
          <TouchableOpacity
            onPress={() => setExamSort('oldest')}
            style={{
              flex: 1,
              padding: 10,
              borderRadius: 12,
              backgroundColor: examSort === 'oldest' ? T.accent : T.card2,
              alignItems: 'center',
              borderWidth: 1,
              borderColor: examSort === 'oldest' ? T.accent : T.border,
            }}
          >
            <Text
              style={{
                color: examSort === 'oldest' ? AT : T.sub,
                fontSize: 12,
                fontWeight: '700',
              }}
            >
        ...
        >
          ...
          />
          {examSearch ? (
            <TouchableOpacity onPress={() => setExamSearch('')}>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ color: T.sub, fontSize: 12 }}>
                    {exam.phase} · {exam.questions} questões
                  </Text>
                </View>
                <View
                  style={{
        ...
        {filteredYears.length === 0 ? (
          <View style={{ alignItems: 'center', padding: 40 }}>
            ...
            <Text style={{ color: T.sub, fontSize: 14, textAlign: 'center' }}>
            ...
            <View key={year} style={{ marginBottom: 12 }}>
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: T.border,
                  marginBottom: expandedYears[year] ? 8 : 0,
                }}
              >
                ...
                <Text style={{ color: T.accent, fontSize: 18 }}>
                  {expandedYears[year] ? '∧' : '∨'}
                </Text>
              </TouchableOpacity>
                  ...
                  >
                    <View
                      style={{
                        ...
                        height: 36,
                        borderRadius: 18,
                        backgroundColor: selUni.color + '20',
                        alignItems: 'center',
                        justifyContent: 'center',
                        marginRight: 10,
                      }}
