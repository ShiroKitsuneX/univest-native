  ...
  const fC = coursesToUse
    ...
    .sort((a, b) => {
      const la = a.toLowerCase(),
        lb = b.toLowerCase(),
        ls = cSrch.toLowerCase()
      if (la === ls && lb !== ls) return -1
      if (la !== ls && lb === ls) return 1
      if (la.startsWith(ls) && !lb.startsWith(ls)) return -1
      if (!la.startsWith(ls) && lb.startsWith(ls)) return 1
    ...
    <View style={{ flex: 1, backgroundColor: T.bg }}>
      ...
      {step === 1 && (
        <>
          ...
          >
            <Text style={{ color: T.muted, fontSize: 10, marginBottom: 4 }}>
              Passo 1 de 3
            </Text>
            <Text
              style={{
      ...
      {step === 2 && (
        <>
          ...
          >
            <Text style={{ color: T.muted, fontSize: 11, marginBottom: 4 }}>
              Passo 2 de 3
            </Text>
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (s1) {
                      hC1('')
                      if (picking === 1) setPick(1)
                    } else if (s2) {
                      hC2('')
                      if (picking === 2) setPick(2)
                    } else if (picking === 1) {
                      hC1(cc)
                      setPick(2)
                    } else {
      ...
      {step === 3 && (
        <>
          ...
          >
            ...
            >
              Escolha para personalizar seu feed
            </Text>
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() =>
                    setUnis(prev =>
                      prev.map(x =>
                        x.id === u.id ? { ...x, followed: !x.followed } : x
                      )
                    )
                  }
                  style={{
