    ...
    <BottomSheet visible={visible} onClose={onClose} T={T}>
      <View style={{ padding: 20, paddingBottom: 24 }}>
        ...
        <TouchableOpacity
          ...
          disabled={!tmpNome.trim()}
          style={{
            padding: 14,
            borderRadius: 16,
            backgroundColor: tmpNome.trim() ? T.accent : T.border,
            alignItems: 'center',
          }}
        >
          <Text
            style={{
              color: tmpNome.trim() ? AT : T.muted,
              fontSize: 15,
              fontWeight: '800',
            }}
          >
